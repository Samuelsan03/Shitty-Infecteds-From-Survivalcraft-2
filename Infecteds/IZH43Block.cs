...
namespace Game
{
	public class IZH43Block : Block
	{
		...
		{
			m_texture = ContentManager.Get<Texture2D>("Textures/Armas De Mierda/izh43 gun");

			Model model = ContentManager.Get<Model>("Models/Armas De Porqueria/izh43");

			ModelMesh mainMesh = model.FindMesh("izh43", true);
		...
		// Bits 1-5: Cantidad de balas (0-2 para IZH43, doble cañón)
