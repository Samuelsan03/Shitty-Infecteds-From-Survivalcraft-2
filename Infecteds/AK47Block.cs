...
namespace Game
{
	public class AK47Block : Block
	{
		...
		{
			m_texture = ContentManager.Get<Texture2D>("Textures/Armas De Mierda/AK47");

			Model model = ContentManager.Get<Model>("Models/Armas De Porqueria/AK47");
