...
namespace Game
{
	public class ComponentNewChaseBehavior : ComponentBehavior, IUpdateable
	{
		...
		public virtual void Attack(ComponentCreature componentCreature, float maxRange, float maxChaseTime, bool isPersistent)
		{
			...
			m_autoChaseSuppressionTime = 0f; // Elimina cualquier supresión para que ataque sin demora

			IsActive = true; // Activa el comportamiento inmediatamente
		}
		...
		public override void Load(ValuesDictionary valuesDictionary, IdToEntityMap idToEntityMap)
		{
			...
			m_componentNewHerdBehavior = Entity.FindComponent<ComponentNewHerdBehavior>(); // Referencia al nuevo herd
		...
		public virtual float ScoreTarget(ComponentCreature componentCreature)
		{
			...
			// --- Modificación: si manada es "player", nunca atacar a un jugador ---
		...
		// Campos (copia exacta de ComponentChaseBehavior, añadiendo el nuevo)
