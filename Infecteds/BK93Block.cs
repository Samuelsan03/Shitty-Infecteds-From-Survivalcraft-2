...
namespace Game
{
	public class BK93Block : Block
	{
		...
		{
			m_texture = ContentManager.Get<Texture2D>("Textures/Armas De Mierda/BK 93");

			Model model = ContentManager.Get<Model>("Models/Armas De Porqueria/BK 93");
		...
		// Bits 1-5: Cantidad de balas (0-2 para BK93, doble cañón)
		...
		{
			return (data & ~0x3E) | ((Math.Clamp(count, 0, 2) & 0x1F) << 1);
		}
