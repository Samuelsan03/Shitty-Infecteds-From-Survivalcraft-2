...
namespace Game
{
	public class PoisonTrailParticleSystem : ParticleSystem<PoisonTrailParticleSystem.Particle>, ITrailParticleSystem
	{
		public Vector3 Position { get; set; }

		public bool IsStopped { get; set; }

		public PoisonTrailParticleSystem(int particlesCount, float size, float maxDuration, Color color) : base(particlesCount)
		{
			this.m_size = size;
			this.m_maxDuration = maxDuration;
			// ÚNICO CAMBIO RESPECTO AL SMOKE: La textura de vómito
		...
		public override bool Simulate(float dt)
		{
			...
			{
				PoisonTrailParticleSystem.Particle particle = base.Particles[i];
				if (particle.IsActive)
				{
					...
					if (particle.Time <= particle.Duration)
					{
						...
						particle.Velocity *= s;
						PoisonTrailParticleSystem.Particle particle2 = particle;
