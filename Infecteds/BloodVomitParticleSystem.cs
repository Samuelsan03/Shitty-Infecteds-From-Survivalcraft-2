...
namespace Game
{
	public class BloodVomitParticleSystem : ParticleSystem<BloodVomitParticleSystem.Particle>
	{
		...
		public BloodVomitParticleSystem(SubsystemTerrain terrain, SubsystemBodies bodies, SubsystemTime time) : base(120)
		{
		...
		public override bool Simulate(float dt)
		{
			...
			{
				BloodVomitParticleSystem.Particle particle = base.Particles[i];
