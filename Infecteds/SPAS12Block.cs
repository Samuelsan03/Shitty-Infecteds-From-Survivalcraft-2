...
namespace Game
{
	public class SPAS12Block : Block
	{
		...
		{
			m_texture = ContentManager.Get<Texture2D>("Textures/Armas De Mierda/SPAS 12");

			Model model = ContentManager.Get<Model>("Models/Armas De Porqueria/SPAS12");
		...
		// Bits 1-5: Cantidad de balas (0-8 para escopeta)
		...
		{
			return (data & ~0x3E) | ((Math.Clamp(count, 0, 8) & 0x1F) << 1);
		}
