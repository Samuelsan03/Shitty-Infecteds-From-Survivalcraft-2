...
namespace Game
{
	public class Mac10Block : Block
	{
		...
		{
			m_texture = ContentManager.Get<Texture2D>("Textures/Armas De Mierda/MAC10");

			Model model = ContentManager.Get<Model>("Models/Armas De Porqueria/MAC10Gun");
		...
		// Bits 1-5: Cantidad de balas (0-30) - MAC-10 usa cargador de 30 balas
